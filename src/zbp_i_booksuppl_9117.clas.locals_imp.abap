...
CLASS lhc_Supplement IMPLEMENTATION.
  ...
  METHOD calculateTotalSupplimPrice.
    IF NOT keys IS INITIAL.
      zcl_aux_travel_det_9117=>calculate_price( it_travel_id =
...
CLASS lsc_supplement IMPLEMENTATION.
  METHOD save_modified.
    DATA: lt_supplements TYPE STANDARD TABLE OF ztb_booksup_9117,
          lv_op_type     TYPE zde_flag_9117,
          lv_updated     TYPE zde_flag_9117.
