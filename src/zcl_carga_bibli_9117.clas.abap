CLASS zcl_carga_bibli_9117 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  PUBLIC SECTION.
...
CLASS zcl_carga_bibli_9117 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA: lt_acc_categ TYPE TABLE OF ztb_ac_cate_9117,
          lt_catego    TYPE TABLE OF ztb_catego_9117,
          lt_clientes  TYPE TABLE OF ztb_cliente_9117,
          lt_clnts_lib TYPE TABLE OF ztb_cln_lib_9117,
          lt_libros    TYPE TABLE OF ztb_libros_9117.
...
******** ZTB_ACC_CATEG ********
    ...
    DELETE FROM ztb_ac_cate_9117.

    INSERT ztb_ac_cate_9117 FROM TABLE @lt_acc_categ.
...
******** ZTB_CATEGO ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_catego_9117.

    INSERT ztb_catego_9117 FROM TABLE @lt_catego.
...
******** ZTB_CATEGO ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_cliente_9117.

    INSERT ztb_cliente_9117 FROM TABLE @lt_clientes.
...
******** ZTB_CLNTS_LIB ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_cln_lib_9117.

    INSERT ztb_cln_lib_9117 FROM TABLE @lt_clnts_lib.
...
'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_libros_9117.

    INSERT ztb_libros_9117 FROM TABLE @lt_libros.
